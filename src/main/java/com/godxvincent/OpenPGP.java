...
public class OpenPGP {
    ...
    private static final PGPAlgorithmSuite pgpAlgorithmSuite = new PGPAlgorithmSuite(PGPHashAlgorithms.SHA_256,
    ...
    // Este parametro solo se usa si se quieren generar las llaves.
    ...
    public ByteArrayOutputStream encryptAndSignToFile(String unencryptedMessage,
                                 String senderUserIdEmail,
                                 String senderPassphrase,
                                 ArmoredKeyPair senderArmoredKeyPair,
                                 String receiverUserId,
        ...
        try (
                ...
                OutputStream bouncyGPGOutputStream = BouncyGPG.encryptToStream()
                        .withConfig(keyring).withAlgorithms(pgpAlgorithmSuite)
                        .toRecipient(receiverUserId)
                        .andSignWith(senderUserIdEmail)
                        .armorAsciiOutput()
                        .andWriteTo(bufferedOutputStream)
